...
urlpatterns = [
    ...
    url(r'^payments/(?P<id>[0-9a-f-]+)/archive/$', views.archive_payment, name="archive_payment"),
    url(r'^payments/(?P<id>[0-9a-f-]+)/unarchive/$', views.unarchive_payment, name="unarchive_payment"),
